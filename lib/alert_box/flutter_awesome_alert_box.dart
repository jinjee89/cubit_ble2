...
class SuccessAlertBoxCenter {
  ...
  Future<void> show() {
    return showDialog(
      ...
      builder: (BuildContext context) {
        return SimpleDialog(
          shape: Border(bottom: BorderSide(width: 2, color: Color(0xFF4CB051))),
          contentPadding: const EdgeInsets.fromLTRB(24, 12, 24, 12),
          children: <Widget>[
            Center(
              child: icon ??
...
class DangerAlertBoxCenter {
  ...
  Future<void> show() {
    return showDialog(
      ...
      builder: (BuildContext context) {
        return SimpleDialog(
          shape: Border(bottom: BorderSide(width: 2, color: Color(0xFFFF5455))),
          contentPadding: const EdgeInsets.fromLTRB(24, 12, 24, 12),
          children: <Widget>[
            Center(
              child: icon ??
...
class WarningAlertBoxCenter {
  ...
  Future<void> show() {
    return showDialog(
      ...
      builder: (BuildContext context) {
        return SimpleDialog(
          shape: Border(bottom: BorderSide(width: 2, color: Color(0xFFFF9800))),
          contentPadding: const EdgeInsets.fromLTRB(24, 12, 24, 12),
          children: <Widget>[
            Center(
              child: icon ??
  ...
  Future<void> show() {
    return showDialog(
      ...
      builder: (BuildContext context) {
        return SimpleDialog(
          backgroundColor: Color(0xFF20242A),
          shape: Border(bottom: BorderSide(width: 2, color: Color(0xFF343436))),
          contentPadding: const EdgeInsets.fromLTRB(24, 12, 24, 12),
          children: <Widget>[
            Center(
              child: icon ??
              ...
              children: <Widget>[
                FlatButton(
                  ...
                  child: Text(
                    ...
                    style:
                        TextStyle(color: buttonTextColorForYes ?? Colors.white),
                  ),
                ),
                SizedBox(
                  width: 4,
                ...
                FlatButton(
                  ...
                  child: Text(
                    buttonTextForNo ?? "No",
                    style:
                        TextStyle(color: buttonTextColorForNo ?? Colors.white),
                  ),
                )
              ],
            )
